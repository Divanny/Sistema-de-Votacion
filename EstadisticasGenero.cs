...
{
    public partial class EstadisticasGenero : Form
    {
        string genero = "";
        ...
        private void EstadisticasGenero_Load(object sender, EventArgs e)
        {
        }
